...
export function worktreeAdd(path: string, branch: string, ref?: string): void {
...
export function worktreeRemove(path: string, force?: boolean): void {
...
export function branchDelete(branch: string, force?: boolean): void {
...
export function commit(message: string, files?: string[]): void {
